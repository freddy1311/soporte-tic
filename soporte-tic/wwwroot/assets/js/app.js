...
(function ($) {
    ...
    function getLanguage() {
        (language == (null || "null")) ? setLanguage(default_lang): false;
    ...
    function initLanguage() {
        // Auto Loader
        if (language != (null || "null") && language !== default_lang)
    ...
    function layoutSetting() {
        ...
        $("input[name='layout']").on('change', function () {
            window.location.href = ($(this).val() == "vertical") ? "/" : "/Layouts/_horizontal";
        });
        ...
        $("input[name='layout-mode']").on('change', function () {
            if($(this).val() == "light") {
                ...
                (body.hasAttribute("data-layout") && body.getAttribute("data-layout") == "horizontal") ? '' : (document.body.setAttribute('data-sidebar', 'dark'), updateRadio('sidebar-color-dark'));
            } else {
